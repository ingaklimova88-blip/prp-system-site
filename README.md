...
Формы принимаются через Netlify Forms (`lead`) на сайте `prp-system.ru`.

Email-уведомление Netlify настроено на `t0083640@yandex.ru`.
...
3. Проверить формы в Netlify Forms.
