...
- Добавлены визуалы из презентации: система Angel, набор cPRP и сенсорный контроль 3ST.
- Добавлен блок под поисковый интент Wordstat: `prp центрифуга`, `аппарат prp`, `prp оборудование`, `система подготовки prp`.
- Покупательский интент раскрыт через блоки для врачей, клиник, закупочных отделов и чек-лист перед запросом КП.
